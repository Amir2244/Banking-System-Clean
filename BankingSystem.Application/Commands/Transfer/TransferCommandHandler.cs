...
{
      public TransferCommandHandler(IUnitOfWork unitOfWork, ICurrentUserService currentUserService) : base(unitOfWork,
          currentUserService)
      {
      }

      protected async override Task<Unit> Logic(TransferCommand request, CancellationToken cancellationToken)
      {
            ...
            var transaction = Transaction.CreateInstance(accountId: source.AccountId,
